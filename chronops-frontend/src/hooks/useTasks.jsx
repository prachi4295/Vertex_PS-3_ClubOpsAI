...
/**
 * Loads tasks from user-scoped storage.
 */
function getLocalTasks(eventId) {
  return getStoredTasks(eventId);
}

/**
 * Saves tasks to user-scoped storage.
 */
function saveLocalTasks(eventId, tasks) {
  saveStoredTasks(eventId, tasks);
}
      ...
      const unsub = onSnapshot(
        ...
        (snap) => {
          ...
          const docs = snap.docs
            ...
            .filter((t) => !t.ownerEmail || t.ownerEmail === currentEmail);
